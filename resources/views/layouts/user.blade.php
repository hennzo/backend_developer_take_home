        ...
        <div class="w-full shadow-sm shadow-slate-950/5 max-w-[280px]">
            ...
            <div class="w-full h-max rounded p-3">
                <ul class="flex flex-col gap-0.5 min-w-60">
                    <li class="flex items-center py-1.5 px-2.5 rounded-md align-middle select-none font-sans transition-all duration-300 ease-in aria-disabled:opacity-50 aria-disabled:pointer-events-none {{request()->is('/') || request()->is('product/*')? 'bg-white text-black': 'bg-transparent text-white'}} hover:text-black dark:hover:text-white hover:bg-slate-200 focus:bg-slate-200 focus:text-black dark:focus:text-white dark:data-[selected=true]:text-white dark:bg-opacity-70">
                        <a href="/" class="flex items-center">
                            Products
                        </a>
                    </li>
                    <li class="flex items-center py-1.5 px-2.5 rounded-md align-middle select-none font-sans transition-all duration-300 ease-in aria-disabled:opacity-50 aria-disabled:pointer-events-none {{request()->is('subscriptions')? 'bg-white text-black': 'bg-transparent text-white'}} hover:text-black dark:hover:text-white hover:bg-slate-200 focus:bg-slate-200 focus:text-black dark:focus:text-white dark:data-[selected=true]:text-white dark:bg-opacity-70">
                        <a href="/subscriptions" class="flex items-center">
                            My subscriptions
                        </a>
                    </li>
                    <li class="flex items-center py-1.5 px-2.5 rounded-md align-middle select-none font-sans transition-all duration-300 ease-in aria-disabled:opacity-50 aria-disabled:pointer-events-none bg-transparent dark:hover:text-white dark:focus:text-white dark:data-[selected=true]:text-white dark:bg-opacity-70 text-red-500 hover:bg-red-500/10 hover:text-error focus:bg-error/10 focus:text-error">
                        <a href="{{ request()->is('admin/*')? '/admin/logout' : '/logout' }}" class="flex items-center">
