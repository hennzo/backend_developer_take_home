    ...
    <div class="flex justify-center items-center h-screen">
        <div class="flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl p-4 md:p-10 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
            ...
            <form method="POST" action="/admin/pricing">
                @csrf
                <div class="max-w-sm">
                    <label for="name-label" class="block text-sm font-medium mb-2 dark:text-white">Name</label>
                ...
                <div class="max-w-sm py-2.5">
                    <label for="duration-label" class="block text-sm font-medium mb-2 dark:text-white">Duration</label>
                    <select name="duration" id="isAdmin-label"  class="py-2.5 sm:py-3 px-4 block w-full border border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                        @for ($duration = 7; $duration <= 365; $duration++)
